...
public class AdminAdd extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "INSERT INTO doctors (username, password, first_name, last_name , specialty) VALUES (? , ? , ? , ? , ?);";
		    PreparedStatement statement = connection.prepareStatement(sql);
		    statement.setString(1, doctor_username);
		    statement.setString(2, doctor_password);
		    statement.setString(3, doctor_firstname);
		    statement.setString(4, doctor_lastname);
		    statement.setString(5, doctor_specialty);
